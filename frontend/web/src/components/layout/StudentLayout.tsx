      ...
      <div className="flex flex-1 flex-col min-w-0 overflow-hidden">
        <header className="flex h-16 items-center justify-between bg-white dark:bg-slate-800 px-4 shadow-sm border-b border-slate-200 dark:border-slate-700 transition-colors duration-200">
          ...
          <div className="flex items-center gap-2">
            ...
            {user && !user.email_verified && verifyEmailPath && (
              <button
                onClick={() => navigate(verifyEmailPath)}
...
const ACCOUNTANT_NAV: NavItem[] = [
  ...
  { label: "Invoices", to: "/accountant/invoices", icon: DocumentTextIcon },
  { label: "Budget", to: "/accountant/budget", icon: ChartBarIcon },
  { label: "Purchase Orders", to: "/accountant/purchase-orders", icon: ClipboardDocumentListIcon },
...
const PARENT_NAV: NavItem[] = [
  ...
  { label: "Health", to: "/parent/health", icon: HeartIcon },
  { label: "Library", to: "/parent/library", icon: BookOpenIcon },
  { label: "Cafeteria", to: "/parent/cafeteria", icon: CakeIcon },
  { label: "Sports", to: "/parent/sports", icon: TrophyIcon },
  { label: "Behavior", to: "/parent/behavior", icon: ExclamationTriangleIcon },
  { label: "Counseling", to: "/parent/counseling", icon: ChatBubbleLeftRightIcon },
