  ...
  return (
    <div className="flex h-screen bg-slate-100 overflow-hidden">
      ...
      <aside className={clsx(
        "fixed inset-y-0 left-0 z-30 flex w-64 flex-col bg-emerald-900 transition-transform duration-300 lg:static lg:translate-x-0",
        open ? "translate-x-0" : "-translate-x-full"
      )}>
        <div className="flex h-16 items-center justify-between px-5 border-b border-emerald-800">
          <div className="flex items-center gap-3">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-white">
              <AcademicCapIcon className="h-5 w-5 text-emerald-700" />
            </div>
        ...
        <div className="mx-4 mt-4 rounded-lg bg-emerald-800/60 px-3 py-2">
      ...
      <div className="flex flex-1 flex-col min-w-0 overflow-hidden">
        <header className="flex h-16 items-center justify-between bg-white px-4 shadow-sm border-b border-slate-200 z-10">
