...
class FeeInvoiceViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return FeeInvoice.objects.filter(school=self.request.user.school)
...
class InstallmentPaymentViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return InstallmentPayment.objects.filter(school=self.request.user.school)
...
class StudentLedgerViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return StudentLedger.objects.filter(school=self.request.user.school)
