    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "grade",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="students.grade"),
                ),
                (
                    "school",
                    models.ForeignKey(
        ...
        migrations.AddIndex(
            model_name="feeinvoice",
            index=models.Index(fields=["due_date", "status"], name="fee_invoice_due_dat_de14fa_idx"),
        ),
    ]
