...
class PeriodAttendanceViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return PeriodAttendance.objects.filter(school=self.request.user.school)
...
class AttendanceLeaveViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return AttendanceLeave.objects.filter(school=self.request.user.school)
...
class AttendanceChangeLogViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return AttendanceChangeLog.objects.filter(school=self.request.user.school)
...
class LeaveBalanceViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return LeaveBalance.objects.filter(school=self.request.user.school)
...
class QRCodeSessionViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return QRCodeSession.objects.filter(school=self.request.user.school)
...
class AttendanceDataArchiveViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return AttendanceDataArchive.objects.filter(school=self.request.user.school)
...
class BiometricCheckinViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return BiometricCheckin.objects.filter(school=self.request.user.school)
...
class RFIDCheckinViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return RFIDCheckin.objects.filter(school=self.request.user.school)
...
class GPSAttendanceViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return GPSAttendance.objects.filter(school=self.request.user.school)
...
class AttendanceDashboardViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return AttendanceDashboard.objects.filter(school=self.request.user.school)
...
class ChronicAbsenceTrackingViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ChronicAbsenceTracking.objects.filter(school=self.request.user.school)
...
class AttendanceReportViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return AttendanceReport.objects.filter(school=self.request.user.school)
...
class BulkAttendanceImportViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return BulkAttendanceImport.objects.filter(school=self.request.user.school)
...
class AttendanceCorrectionWorkflowViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return AttendanceCorrectionWorkflow.objects.filter(school=self.request.user.school)
...
class AttendanceHistoryViewViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return AttendanceHistoryView.objects.filter(school=self.request.user.school)
...
class AttendancePatternsViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return AttendancePatterns.objects.filter(school=self.request.user.school)
...
class RealTimeDashboardViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return RealTimeDashboard.objects.filter(school=self.request.user.school)
