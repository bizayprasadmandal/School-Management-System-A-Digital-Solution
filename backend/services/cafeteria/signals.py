"""Cafeteria signals — audit logging."""
...
for model_name in ["MealMenu", "MealPlan", "MealBooking", "DietaryRestriction"]:
    @receiver(post_save, sender=f"cafeteria.{model_name}")
    def log_save(sender, instance, created, **kwargs):
        _log(sender, instance, "created" if created else "updated")

    @receiver(post_delete, sender=f"cafeteria.{model_name}")
