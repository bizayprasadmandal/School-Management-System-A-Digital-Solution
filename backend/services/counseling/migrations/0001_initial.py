    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "intervention_plan",
                    models.TextField(blank=True, help_text="Proposed intervention plan"),
                ),
                (
                    "outcome",
                    models.TextField(blank=True, help_text="Outcome after action taken"),
                ),
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["student"], name="student_ref_student_810070_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "duration_minutes",
                    models.PositiveSmallIntegerField(default=30, help_text="Duration in minutes"),
                ),
                (
                    "location",
                    models.CharField(
                ...
                (
                    "reason",
                    models.TextField(blank=True, help_text="Reason for the appointment"),
                ),
                (
                    "notes",
                    models.TextField(blank=True, help_text="Counselor's session notes (post-session)"),
                ),
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["scheduled_date"], name="counseling__schedul_8d5dbe_idx"),
                ],
            },
        ),
    ]
