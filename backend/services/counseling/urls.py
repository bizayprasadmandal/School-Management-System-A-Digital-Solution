...
router.register(
    r"screening-responses",
    views.ScreeningResponseViewSet,
    basename="screening-response",
)
...
router.register(
    ...
    views.ProgressMilestoneViewSet,
    basename="progress-milestone",
)
...
router.register(
    r"group-attendance",
    views.GroupSessionAttendanceViewSet,
...
router.register(
    ...
    views.CollegeApplicationViewSet,
    basename="college_applications",
)
...
router.register(
    r"survey-responses",
    views.CounselingSurveyResponseViewSet,
...
router.register(
    r"course-recommendations",
    views.CourseRecommendationViewSet,
    basename="course_recommendations",
)
...
router.register(
    r"peer-mentoring-sessions",
    views.PeerMentoringSessionViewSet,
    basename="peer_mentoring_sessions",
)
router.register(r"referral-tracking", views.ReferralTrackingViewSet, basename="referral_tracking")
router.register(
    r"restorative-commitments",
    views.RestorativeCommitmentViewSet,
    basename="restorative_commitments",
)
router.register(
    r"restorative-sessions",
    views.RestorativeJusticeSessionViewSet,
    basename="restorative_sessions",
)
...
router.register(
    r"session-attachments",
    views.SessionAttachmentViewSet,
    basename="session_attachments",
)
router.register(
    r"special-education-referrals",
    views.SpecialEducationReferralViewSet,
    basename="special_education_referrals",
)
router.register(
    r"workshop-registrations",
    views.WorkshopRegistrationViewSet,
    basename="workshop_registrations",
)

urlpatterns = [
    # Parent portal: guardian-scoped per-child data
    path("sessions/children/", core_parent_portal.counseling_sessions_children),
    path("referrals/children/", core_parent_portal.counseling_referrals_children),
    path("", include(router.urls)),
    path(
        "dashboard/stats/",
        views.CounselorDashboardStatsView.as_view(),
