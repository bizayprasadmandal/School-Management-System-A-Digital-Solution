"""Admissions signals — audit logging."""
...
for model_name in ["EnrollmentIntake", "Application", "ApplicationDocument", "ApplicationReview"]:
    @receiver(post_save, sender=f"admissions.{model_name}")
    def log_save(sender, instance, created, **kwargs):
        _log(sender, instance, "created" if created else "updated")

    @receiver(post_delete, sender=f"admissions.{model_name}")
