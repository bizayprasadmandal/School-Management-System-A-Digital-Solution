...
for model_name in ["AlumniProfile", "AlumniEvent", "AlumniDonation", "AlumniChapter"]:
    @receiver(post_save, sender=f"alumni.{model_name}")
    def log_save(sender, instance, created, **kwargs):
        _log(sender, instance, "created" if created else "updated")

    @receiver(post_delete, sender=f"alumni.{model_name}")
