...
router.register("login-history", views.LoginHistoryViewSet, basename="login-history")
router.register("api-keys", views.APIKeyViewSet, basename="api-key")
router.register("devices", views.DeviceManagementViewSet, basename="device")
router.register("password-policies", views.PasswordPolicyViewSet, basename="password-policy")
router.register("ip-whitelist", views.IPWhitelistViewSet, basename="ip-whitelist")
router.register("oauth-providers", views.OAuthProviderViewSet, basename="oauth-provider")
router.register("activities", views.UserActivityViewSet, basename="activity")
router.register("session-policies", views.SessionPolicyViewSet, basename="session-policy")
