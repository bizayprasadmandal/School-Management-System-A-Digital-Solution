"""URL Configuration for health_clinic."""
...
app_name = "health_clinic_v1"

router = DefaultRouter()
router.register(r"health-record", HealthRecordViewSet, basename="health-record")
router.register(r"nurse-visit", NurseVisitViewSet, basename="nurse-visit")
router.register(r"immunization", ImmunizationViewSet, basename="immunization")
router.register(r"medication-log", MedicationLogViewSet, basename="medication-log")
router.register(r"health-form", HealthFormViewSet, basename="health-form")
router.register(r"health-form-submission", HealthFormSubmissionViewSet, basename="health-form-submission")
router.register(r"allergy-management", AllergyManagementViewSet, basename="allergy-management")
router.register(r"chronic-condition-tracking", ChronicConditionTrackingViewSet, basename="chronic-condition-tracking")
router.register(r"emergency-plan", EmergencyPlanViewSet, basename="emergency-plan")
...
router.register(r"screening-result", ScreeningResultViewSet, basename="screening-result")
router.register(r"medication-inventory", MedicationInventoryViewSet, basename="medication-inventory")
router.register(r"medication-prescription", MedicationPrescriptionViewSet, basename="medication-prescription")
router.register(r"parent-notification", ParentNotificationViewSet, basename="parent-notification")
router.register(r"health-compliance", HealthComplianceViewSet, basename="health-compliance")
router.register(r"nurse-schedule", NurseScheduleViewSet, basename="nurse-schedule")
router.register(r"incident-report", IncidentReportViewSet, basename="incident-report")
router.register(r"medical-referral", MedicalReferralViewSet, basename="medical-referral")
router.register(r"health-report", HealthReportViewSet, basename="health-report")
router.register(r"health-alert", HealthAlertViewSet, basename="health-alert")
router.register(r"health-education", HealthEducationViewSet, basename="health-education")
router.register(r"telehealth-session", TelehealthSessionViewSet, basename="telehealth-session")
