...
class DirectMessageViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return DirectMessage.objects.filter(school=self.request.user.school)
...
class ChatGroupViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ChatGroup.objects.filter(school=self.request.user.school)
...
class GroupMessageViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return GroupMessage.objects.filter(school=self.request.user.school)
...
class ParentTeacherChatViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ParentTeacherChat.objects.filter(school=self.request.user.school)
...
class ParentTeacherMessageViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ParentTeacherMessage.objects.filter(school=self.request.user.school)
...
class VideoConferenceViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return VideoConference.objects.filter(school=self.request.user.school)
...
class ConferenceParticipantViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ConferenceParticipant.objects.filter(school=self.request.user.school)
...
class FileAttachmentViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return FileAttachment.objects.filter(school=self.request.user.school)
...
class MessageThreadViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return MessageThread.objects.filter(school=self.request.user.school)
...
class ReadReceiptViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ReadReceipt.objects.filter(school=self.request.user.school)
...
class TypingIndicatorViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return TypingIndicator.objects.filter(school=self.request.user.school)
...
class MessageReactionViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return MessageReaction.objects.filter(school=self.request.user.school)
...
class VoiceMessageViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return VoiceMessage.objects.filter(school=self.request.user.school)
...
class CommunicationLogViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return CommunicationLog.objects.filter(school=self.request.user.school)
