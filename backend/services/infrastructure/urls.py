...
router.register(r"room-allocations", views.RoomAllocationViewSet, basename="room-allocation")
...
router.register(r"asset-lifecycle", views.AssetLifecycleViewSet, basename="asset-lifecycle")
router.register(r"warranty-claims", views.WarrantyClaimViewSet, basename="warranty-claim")
router.register(r"space-reservations", views.SpaceReservationViewSet, basename="space-reservation")
router.register(r"utility-tracker", views.UtilityTrackerViewSet, basename="utility-tracker")
router.register(r"safety-inspections", views.SafetyInspectionViewSet, basename="safety-inspection")
router.register(r"compliance-records", views.InfrastructureComplianceRecordViewSet, basename="compliance-record")
router.register(r"vendor-contracts", views.VendorContractViewSet, basename="vendor-contract")
router.register(r"emergency-plans", views.InfrastructureEmergencyPlanViewSet, basename="emergency-plan")
router.register(r"reports", views.InfrastructureReportViewSet, basename="infrastructure-report")
