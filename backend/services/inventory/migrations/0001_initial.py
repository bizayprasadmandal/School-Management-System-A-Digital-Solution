    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "current_stock",
                    models.PositiveIntegerField(default=0, help_text="Current quantity on hand"),
                ),
                (
                    "minimum_stock",
                    models.PositiveIntegerField(default=0, help_text="Low-stock alert threshold"),
                ),
                (
                    "maximum_stock",
                    models.PositiveIntegerField(default=0, help_text="Maximum desired stock level"),
                ),
                (
                    "location",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_terms",
                    models.CharField(blank=True, help_text="e.g. Net 30", max_length=100),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reference_number",
                    models.CharField(blank=True, help_text="PO #, invoice #, etc.", max_length=50),
                ),
