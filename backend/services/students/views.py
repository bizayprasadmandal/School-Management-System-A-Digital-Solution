...
class StudentContactViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return StudentContact.objects.filter(school=self.request.user.school)
...
class StudentCustomFieldValueViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return StudentCustomFieldValue.objects.filter(school=self.request.user.school)
...
class StudentPhotoViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return StudentPhoto.objects.filter(school=self.request.user.school)
...
class StudentIDCardViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return StudentIDCard.objects.filter(school=self.request.user.school)
...
class StudentStatusHistoryViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return StudentStatusHistory.objects.filter(school=self.request.user.school)
...
class SiblingTrackingViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return SiblingTracking.objects.filter(school=self.request.user.school)
...
class StudentCategoryMembershipViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return StudentCategoryMembership.objects.filter(school=self.request.user.school)
...
class StudentTagAssignmentViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return StudentTagAssignment.objects.filter(school=self.request.user.school)
...
class StudentNoteViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return StudentNote.objects.filter(school=self.request.user.school)
...
class StudentArchiveViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return StudentArchive.objects.filter(school=self.request.user.school)
...
class StudentSocialMediaViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return StudentSocialMedia.objects.filter(school=self.request.user.school)
...
class StudentPortfolioViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return StudentPortfolio.objects.filter(school=self.request.user.school)
...
class StudentWellnessViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return StudentWellness.objects.filter(school=self.request.user.school)
