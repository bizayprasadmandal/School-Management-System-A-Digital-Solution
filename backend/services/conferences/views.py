...
class ConferenceSlotViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ConferenceSlot.objects.filter(school=self.request.user.school)
...
class ConferenceBookingViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ConferenceBooking.objects.filter(school=self.request.user.school)
...
class ConferenceReminderViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ConferenceReminder.objects.filter(school=self.request.user.school)
...
class ConferenceNotesViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ConferenceNotes.objects.filter(school=self.request.user.school)
...
class FollowUpTrackingViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return FollowUpTracking.objects.filter(school=self.request.user.school)
...
class ConferenceAvailabilityViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ConferenceAvailability.objects.filter(school=self.request.user.school)
...
class ConferenceFeedbackViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ConferenceFeedback.objects.filter(school=self.request.user.school)
...
class ConferenceHistoryViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ConferenceHistory.objects.filter(school=self.request.user.school)
...
class VirtualConferenceViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return VirtualConference.objects.filter(school=self.request.user.school)
