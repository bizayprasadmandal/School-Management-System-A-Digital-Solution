...
class PeriodViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Period.objects.filter(school=self.request.user.school)
...
class TeacherTimetableViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return TeacherTimetable.objects.filter(school=self.request.user.school)
...
class ExamScheduleEntryViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return ExamScheduleEntry.objects.filter(school=self.request.user.school)
...
class TimetableTemplateSlotViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return TimetableTemplateSlot.objects.filter(school=self.request.user.school)
...
class TeacherPreferenceViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return TeacherPreference.objects.filter(school=self.request.user.school)
